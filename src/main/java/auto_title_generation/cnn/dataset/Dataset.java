...
public class Dataset {
	...
	public static Dataset load(String filePath, String tag, int lableIndex) {
		...
		try {
			Dataset.class.getResourceAsStream(filePath);
			BufferedReader in = new BufferedReader(new InputStreamReader(Dataset.class.getResourceAsStream(filePath)));
			String line;
	...
	public static void main(String[] args) {
		...
		d.lableIndex = 10;
		Record r = d.new Record(new double[] { 3, 2, 2, 5, 4, 5, 3, 11, 3, 12, 4 });
